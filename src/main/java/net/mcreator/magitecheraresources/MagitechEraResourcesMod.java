package net.mcreator.magitecheraresources;
...
@Mod("magitech_era_resources")
public class MagitechEraResourcesMod {
	public static final Logger LOGGER = LogManager.getLogger(MagitechEraResourcesMod.class);
	public static final String MODID = "magitech_era_resources";

	public MagitechEraResourcesMod() {
		...
		MagitechEraResourcesModTabs.REGISTRY.register(bus);
